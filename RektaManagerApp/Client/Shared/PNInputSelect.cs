...
namespace RektaManagerApp.Client.Shared
{
    public class PNInputSelect<TValue> : InputSelect<TValue>
    {
        protected override bool TryParseValueFromString(string value, out TValue result, out string validationErrorMessage)
        {
            ...
            else if (typeof(TValue) == typeof(Guid))
            {
                ...
                result = default;
                validationErrorMessage = $"The selected value {value} is not a Guid or uuid";
                return false;
            }
            else
            {
